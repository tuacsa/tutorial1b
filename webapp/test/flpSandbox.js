		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#accenturetutorial1bui5tutorial1b-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accenturetutorial1bui5tutorial1b-display": {
								"semanticObject": "accenturetutorial1bui5tutorial1b",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=accenture.tutorial1b.ui5.tutorial1b",
									"url": sap.ui.require.toUrl("accenture/tutorial1b/ui5/tutorial1b")
								}
							}
						}
					}
